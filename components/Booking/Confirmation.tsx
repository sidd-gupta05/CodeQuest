...
//   authUser: any; // Add authUser prop
//   onBack?: () => void;
// }
...
//   selectedAddons,
//   patientDetails,
//   authUser, // Receive authUser prop
//   onBack,
// }: ConfirmationProps) {
...
export default function Confirmation({
  ...
  useEffect(() => {
    const confirmBookingAndSendEmail = async () => {
      const userEmail = getUserEmail();
      ...
      try {
        ...
        // Use the booking ID from the server response
        setBookingId(result.bookingId);

        // Generate QR code data after booking ID is available from server
